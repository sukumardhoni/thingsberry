...
module.exports = {
  ...
  db: {
    uri: process.env.DEV_MONGOHQ_URL || process.env.DEV_MONGOLAB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/tberry-dev',
    options: {
      user: '',
      pass: ''
    },
  ...
  facebook: {
    /* clientID: process.env.FACEBOOK_ID || '239001833102223',
     clientSecret: process.env.FACEBOOK_SECRET || '402c193bafebde83e46d22e9ba6334d1',*/
    clientID: process.env.FACEBOOK_ID || '239001833102223',
    clientSecret: process.env.FACEBOOK_SECRET || '402c193bafebde83e46d22e9ba6334d1',
