...
angular.module('core').directive('tbHeaderCarousel', ["dataShare", "$state", "$localStorage", "ratingService", "NotificationFactory", function (dataShare, $state, $localStorage, ratingService, NotificationFactory) {
  return {
    restrict: 'E',
    replace: true,
    scope: {
...
angular.module('core').directive('tbHeaderCarouselOptions', ["dataShare", "$state", "$localStorage", "ratingService", "NotificationFactory", function (dataShare, $state, $localStorage, ratingService, NotificationFactory) {
  return {
    restrict: 'E',
    replace: true,
    scope: {
...
angular.module('core').directive('tbLinkButton', ["$location", function ($location) {
  return {
    restrict: 'E',
    replace: true,
...
angular.module('core').directive('tbSmallSnippet', ["dataShare", "$state", "$localStorage", "ratingService", "NotificationFactory", function (dataShare, $state, $localStorage, ratingService, NotificationFactory) {
  return {
    restrict: 'E',
    replace: true,
